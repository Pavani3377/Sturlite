...
class _CustomTextFieldSearchState extends State<CustomTextFieldSearch> {
  ...
  var mHoverColor = const Color(0xFFE3F2FD);
  var mSaveButton = const Color(0xFF4098D7);
  var mSaveButtonBorder = const Color(0x6EB1E1FF);
  var mGreyDivider = const Color(0x1F000000);
  var mTextFieldBorder = const Color(0xff9FB3C8);
  var mErrorColor = const Color(0xFFC62828);
      ...
      itemBuilder: (context, i) {
        return Column(crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            ...
            if(i==0&&widget.showAdd!=false)
            const Divider(height: 1,color: Color(0xFF4098D7)),
    ...
    return OverlayEntry(
        builder: (context) => Positioned(
          ...
          child: CompositedTransformFollower(
            ...
            offset: Offset(0.0, overlaySize.height + 10.0),
    ...
    return CompositedTransformTarget(
      ...
      child: TextFormField(
        ...
        onChanged: (String value) {
          ...
          if (value.length >= widget.minStringLength) {
